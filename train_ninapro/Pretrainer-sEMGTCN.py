...
def main():
    parser = argparse.ArgumentParser(
        description='Pretrain TCN Multi-s-net with subject-level K-fold')
    ...
    parser.add_argument('--save_dir', type=str,
                        default='../result/ninapro/checkpoints_fold_pretrain/TCN')
    ...
    for fold_idx, val_subjects_np in enumerate(folds):
        ...
        print("\n" + "=" * 60)
        print(f"⭐ TCN Fold {fold_idx+1}/{args.k_folds}")
        ...
        for epoch in range(1, args.epoch + 1):
            ...
            print(f"[TCN Fold {fold_idx+1} | Epoch {epoch:03d}] "
        ...
        print(f"[TCN Fold{fold_idx+1}] ✅ Finished. Best NRMSE: {best_nrmse:.4f}")

    print("🎉 TCN K-fold pretraining finished.")
