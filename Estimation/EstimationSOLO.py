...
def estimation(test_subject):
    ...
    if not os.path.exists(
            f'/mnt/data_nvme/zwc/semg-code/resultFinal/ninapro/model_estimation/{model_name}/{trans_method}'):
        os.makedirs(f'/mnt/data_nvme/zwc/semg-code/resultFinal/ninapro/model_estimation/{model_name}/{trans_method}')
    dp.to_excel(
        f'/mnt/data_nvme/zwc/semg-code/resultFinal/ninapro/model_estimation/{model_name}/{trans_method}/{test_subject}_joint.xlsx',
        index=False)
